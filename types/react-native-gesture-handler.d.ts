...
declare module 'react-native-gesture-handler' {
  ...
  export class ScrollView extends React.Component<NativeViewGestureHandlerProperties & ScrollViewProperties> {}
  ...
  export class ToolbarAndroid extends React.Component<NativeViewGestureHandlerProperties & ToolbarAndroidProperties> {}
  ...
  export class FlatList extends React.Component<NativeViewGestureHandlerProperties & FlatListProperties<any>> {}
...
declare module 'react-native-gesture-handler/Swipeable' {
  ...
  interface SwipeableProperties {
    ...
    renderLeftActions?: (progressAnimatedValue: Animated.Value, dragAnimatedValue: Animated.Value) => React.ReactNode
    renderRightActions?: (progressAnimatedValue: Animated.Value, dragAnimatedValue: Animated.Value) => React.ReactNode
